...
def _spawn_aruco_id(aruco_id: int) -> int:
    return int(aruco_id) % _SPAWN_ARUCO_ID_COUNT
...
class AutoSpawnPanel:
    ...
    def _random_spawn(self):
        ...
        for zi in selected:
            ...
            # Spawned boxes use only the 0/1/2 marker set, even for zones 3+.
            aruco_id = zi % _SPAWN_ARUCO_ID_COUNT
