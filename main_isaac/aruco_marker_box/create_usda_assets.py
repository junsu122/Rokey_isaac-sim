...
실행 방법:
    ...
    python /home/rokey/Rokey_isaac-sim-main/aruco_marker_box/create_usda_assets.py

    # 또는 Isaac Sim 내부 Script Editor 에서:
    exec(open("/home/rokey/Rokey_isaac-sim-main/aruco_marker_box/create_usda_assets.py").read())
...
_ARUCO_DIR = (
    "/home/rokey/Rokey_isaac-sim-main/main_isaac/robots/m0609"
