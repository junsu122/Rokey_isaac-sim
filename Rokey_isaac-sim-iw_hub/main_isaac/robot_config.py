...
# ── 경로 설정 ─────────────────────────────────────────────────────────
WAREHOUSE_USD     = str(_BASE / "usd" / "warehouse_v7.usda")
...
# IW Hub USD (v1: lidar ActionGraph 포함, v2는 lidar 없음)
...
#
_POD_USD = "/home/rokey/dev_ws/isaac_sim/src/Rokey_isaac-sim/main_isaac/usd/pot_v1.usda"
...
ROBOT_REGISTRY = [
    ...
    # ── IW Hub #1 ────────────────────────────────────────────────────
    # 역할: 물품 이송 (이동은 smart_factory ROS2 패키지가 담당)
    # 이름은 ROS2 토픽과 일치해야 한다: /iw_hub_01/cmd_vel, /iw_hub_01/odom
    {
        "type"      : "iw_hub",
        "name"      : "iw_hub_01",
        "spawn_xyz" : (0.0, 0.0, 0.0),   # ★ 스폰 위치
        "spawn_yaw" : 0.0,
    },
